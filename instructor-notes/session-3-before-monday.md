...
## Must, before Monday: five things, about 35 minutes
...
## Worth it, if there is time: three things, about an hour

| # | Do | Min | Where |
|---|---|---|---|
| 6 | One read-through of the page at Core only, the aid beside you, clicking each answer the aid names. The long-form worksheet is there if you want it; notes go in `notes-verbatim.md` beside it | 45 | the live page; `docs/changes/2026-09-19-session-3-manual-pass/worksheet.md` |
| 7 | Post Canvas post 1 (the 5:45 window) and post 2 (the corrections). Hold post 3 until after class | 10 | `instructor-notes/session-3-canvas-posts.md` |
...
- Polls loaded. Aid printed and in reach. The three chat lines below ready to paste.
- In the room from 5:45 for setup questions. At 6:00, step 1 of the aid.
...
- Post Canvas post 3 with its date filled.
- Tell the next pass three things, one line each: who the three non-advisors are, whether the two
  law items are checked, and what the room said in the §08 harvest. Each one removes a hedge.
