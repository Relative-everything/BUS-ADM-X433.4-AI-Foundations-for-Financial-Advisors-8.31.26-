...
### 7.2 Page hits to check

Neither claim is expected on a lesson page; both were spoken. Verify before Monday with a grep across
`session-*/index.html` for the token-cost ratio and for "portability". If either is baked into a
page it is a page fix, not a spoken correction. 10 minutes.
...
| A9 | VERIFY | Grep every lesson page for the 2x token-cost ratio and for portability wording; fix any page hit | `session-*/index.html` | — | 10 | BUILDABLE | Grep returns 0 on pages |
...
**Group A: 242 minutes. JARED-ONLY within it: 52.**
...
| Day | Items | Min | Notes |
|---|---|---|---|
| **Thu 17** | E1, E2, E3 decided; A1, A3, A10, B3 | 37 | All JARED-ONLY. Nothing can be built until E1 is answered. |
| **Fri 18** | A2, A9, B1, B7, then commit, push, validators | 45 | Group 1. Expect V2, V6, `#pnum` and restyle_sweep red by design. |
...
**Total: 407 minutes, about 6.8 hours across four days**, of which 92 minutes are JARED-ONLY and
315 are BUILDABLE.
