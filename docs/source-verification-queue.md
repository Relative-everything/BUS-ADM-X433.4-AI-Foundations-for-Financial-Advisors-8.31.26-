...
| References standing behind an EMPTY `last_verified` | **154** of 187 |
| Moving targets | 22 |
...
| 2 | `src-case` | The Cole household | *n/a* | *n/a* | 14 | no | S1 `#s1` · S3 `#s7` · S3 `#s10` · S3 `#s16` · S4 `#s2`×2 · S4 `#sRSP` · S4 `#s5` · S4 `#sW1` · S4 `#sW2`×2 · S4 `#s7`×2 · S4 `#sWS` |
