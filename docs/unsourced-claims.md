...
### 6. `session-3/index.html:1459` — `#s12` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-3/index.html:1459` |
| Section | `#s12` (`core`) |
| Region | R1 — body prose |
| Marker | **[UNCONFIRMED]** |
...
### 7. `session-4/index.html:1563` — `#sW1` — **[UNCONFIRMED]**
...
### 8. `session-4/index.html:1616` — `#sW2` — **[UNCONFIRMED]**
...
### 9. `session-4/index.html:1525` — `#sW1` — **[UNCONFIRMED]**
...
### 10. `session-4/index.html:1601` — `#sW2` — **[UNCONFIRMED]**
