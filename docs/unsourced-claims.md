...
### 1. `session-4/index.html:1747` — `#sWS` — **[NEEDS SOURCE]**

> [NEEDS SOURCE]

| | |
|---|---|
| File and line | `session-4/index.html:1747` |
...
### 2. `session-3/index.html:2273` — `#s16` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-3/index.html:2273` |
| Section | `#s16` (`core`) |
...
### 3. `session-4/index.html:1580` — `#sW1` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-4/index.html:1580` |
...
### 4. `session-4/index.html:1548` — `#sW1` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-4/index.html:1548` |
| Section | `#sW1` (`advanced`) |
| Region | R1 — body prose |
| Marker | **[UNCONFIRMED]** |
...
### 5. `session-2/index.html:1599` — `#s6` — **[NEEDS SOURCE]**

> [NEEDS SOURCE]

| | |
|---|---|
| File and line | `session-2/index.html:1599` |
| Section | `#s6` (`core`) |
| Region | R1 — body prose |
| Marker | **[NEEDS SOURCE]** |
...
### 6. `session-4/index.html:1524` — `#s5` — **[NEEDS SOURCE]**

> [NEEDS SOURCE]

| | |
|---|---|
| File and line | `session-4/index.html:1524` |
| Section | `#s5` (`core`) |
| Region | R1 — body prose |
| Marker | **[NEEDS SOURCE]** |
...
### 7. `session-4/index.html:1681` — `#s7` — **[NEEDS SOURCE]**

> [NEEDS SOURCE]

| | |
|---|---|
| File and line | `session-4/index.html:1681` |
| Section | `#s7` (`core`) |
| Region | R1 — body prose |
| Marker | **[NEEDS SOURCE]** |
...
### 9. `session-3/index.html:1608` — `#s12` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-3/index.html:1608` |
| Section | `#s12` (`core`) |
| Region | R1 — body prose |
| Marker | **[UNCONFIRMED]** |
...
### 10. `session-4/index.html:1586` — `#sW1` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-4/index.html:1586` |
| Section | `#sW1` (`advanced`) |
| Region | R1 — body prose |
| Marker | **[UNCONFIRMED]** |
...
### 11. `session-4/index.html:1639` — `#sW2` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-4/index.html:1639` |
...
### 12. `session-4/index.html:1548` — `#sW1` — **[UNCONFIRMED]**
...
### 13. `session-4/index.html:1624` — `#sW2` — **[UNCONFIRMED]**

> [UNCONFIRMED]

| | |
|---|---|
| File and line | `session-4/index.html:1624` |
| Section | `#sW2` (`advanced`) |
| Region | R1 — body prose |
| Marker | **[UNCONFIRMED]** |
